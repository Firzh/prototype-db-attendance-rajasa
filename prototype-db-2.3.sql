...
CREATE TABLE `ruangan` (
  `ruangan_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `ip_address` varchar(45) UNIQUE NOT NULL COMMENT 'Static IP ESP32',
  `lokasi` varchar(100) DEFAULT NULL, -- butuh detail
...
--
-- 2. Tabel Guru & Staff (Referensi untuk users role guru/admin)
--
